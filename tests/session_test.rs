...
fn test_full_session_lifecycle() {
    ...
    assert!(stdout.contains("active"), "current session should be active");
    ...
    assert!(stdout.contains("paused"), "paused session should show paused state");
...
fn test_session_list() {
    ...
    assert!(stdout.contains("active") || stdout.contains("ended"), "list should contain session state");
}
